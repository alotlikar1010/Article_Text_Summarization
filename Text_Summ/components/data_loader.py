from Text_Summ.components.article_dataset import ArticleDataset
...
class ArticleDataLoader(pl.LightningModule):
    """
    ArticleDataLoader class is a subclass of pl.LightningDataModule
    ArticleDataLoader its inhiriate from pl.LightningDataModule
    ...
    def prepare_data(self):
        ...
        train_data =pd.read_csv(self.train_file_path, nrows= self.nrows/0.80,encoding='latin-1')
    ...
    def train_dataloader(self):
        ...
        """
        train_data = ArticleDataset(source_texts=self.train_dataset[0],
    ...
    def val_dataloader(self):
        ...
        """
        val_data = ArticleDataset(source_texts=self.val_dataset[0],
